/* Interactive Lecture: Anxiety as a Signal */
...
const I18N = {
  zh: {
    ...
    catalogHome: '返回目录',
    heroLabel: '互动讲座 · 教育用途',
    heroTitle: '焦虑是信号，不是敌人',
    heroDesc: '一场关于焦虑本质、思维模式与大脑通路的现场互动讲座。演示者可在各模块输入听众案例，实时投射到大屏展示。',
    enterLecture: '进入讲座',
    disclaimerTitle: '非诊断声明',
    disclaimerDesc: '本讲座内容仅供心理教育与自我觉察参考，不能替代专业心理或医疗诊断与治疗。若您或听众感到持续困扰、功能受损或出现危机，请寻求持证心理健康专业人士的帮助。',
    outline1Title: '焦虑是信号', outline1Desc: '理解焦虑的功能，对比正性焦虑与负性焦虑。',
    ...
    presenterHint: '在此输入听众案例，选择模式后投射到大屏。也可在各章节互动区直接操作。',
    caseLabel: '案例描述', patternLabel: '思维模式（可选）', sectionLabel: '所属章节',
    showOnScreen: '投射到大屏', clearBoard: '清空大屏',
    footerText: '仅供心理教育 · 非临床诊断',
    section1Badge: '第一部分', section1Title: '焦虑是信号',
  ...
  en: {
    appTitle: 'Anxiety as Signal',
    catalogHome: 'Back to catalog',
    heroLabel: 'Interactive Lecture · Educational',
    heroTitle: 'Anxiety Is a Signal, Not an Enemy',
    ...
    outline1Title: 'Anxiety as Signal', outline1Desc: 'Understand anxiety\'s function; compare positive vs. negative anxiety.',
    ...
    presenterHint: 'Enter audience cases here and project to screen. You can also interact directly in each section.',
    caseLabel: 'Case description', patternLabel: 'Pattern (optional)', sectionLabel: 'Section',
    showOnScreen: 'Project to Screen', clearBoard: 'Clear Screen',
    ...
    projectSnapshot: 'Project to Screen',
    ...
    section2Intro: 'Edit the case, rate intensity with a slider, and project to screen for live interaction.',
    scenarioLabel: 'Case',
    ...
    projectPatternSnapshot: 'Project to Screen',
    ...
    return `
      <article class="pattern-card card" data-pattern="${p.id}">
        ...
        <div class="pattern-actions">
          <button type="button" class="btn btn-primary pattern-show-btn" data-pattern="${p.id}">${t('showOnScreen')}</button>
        </div>
      </article>`;
  }).join('');
}
